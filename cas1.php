...
<body>
    ...
    <?php
            ...
            function error_passanduser()
            {          
                //Si le login et le mot de passe sont incorrect, alors renvoyer :
                echo "<p style='color:purple;'>L'username et le password sont incorrect.</p>";
            }
